...
import { getGoogleAuthUrl, getGoogleAccessToken, getGoogleUserInfo, type GoogleUserInfo } from '@/lib/oauth/providers';
...
export async function GET(request: NextRequest) {
  ...
  await createOAuthState(state, 'google', `${mode}:${priceId}:${redirect}`);
