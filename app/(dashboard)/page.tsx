  ...
  return (
    <div className="w-full flex flex-col h-[500px] overflow-hidden select-none pointer-events-none bg-white">
      ...
      {allDayEvents.length > 0 && (
        <div className="flex-none border-b border-gray-200 bg-gray-50 hidden sm:block">
          <div className="flex">
          ...
          >
            ...
            {meetings.map((meeting, index) => {
              ...
              return (
                <li
                  key={`meeting-${index}`}
                  className="relative mt-px flex hidden sm:flex"
                  style={{
                    gridRow: `${startRow} / span ${duration}`,
                    gridColumn: `${dayColumn} / span 1`,
                    paddingRight: '2px',
                ...
                >
                  <div
                    className="group flex flex-col text-xs transition-colors border-2 border-dashed rounded-md z-10 overflow-hidden px-1.5 py-1 h-full w-full shadow-sm hover:shadow-md cursor-pointer"
                    style={{
